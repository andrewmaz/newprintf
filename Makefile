...
#    Updated: 2018/02/15 16:13:50 by amazurok         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PRF_SRC = 	ft_addchar.o ft_check_key.o ft_del_key.o ft_itoa_base.o ft_myputustr_fd.o \
			ft_n.o ft_new_list.o ft_nonoercent.o ft_print_char_str.o ft_print_date.o \
			...
			ft_res_separate.o ft_search_in_line.o ft_size2dig.o ft_strtounicat.o \
